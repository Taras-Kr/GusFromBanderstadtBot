    ...
    public void onUpdateReceived(Update update) {
        ...
        if (update.hasMessage() && update.getMessage().getText().equals("/start")) {
            ...
            SendMessage message = createMessage("Ґа-ґа-ґа!\n" +
                    ...
                    "\n" +
                    "Цей бот ми створили для того, щоб твій гусак прокачався з рівня звичайної свійської худоби до рівня" +
                    " біологічної зброї, здатної нищити ворога. \n" +
                    "\n" +
        ...
        if (update.hasCallbackQuery()) {
            ...
            if (update.getCallbackQuery().getData().equals("level_3_task") && getLevel(chatId) == 3) {
                ...
                SendMessage message = createMessage("*Вітаємо на останньому рівні! Твій гусак - готова біологічна" +
                        " зброя - бандерогусак.*\n" +
                        "Баланс: 50 монет. \n" +
